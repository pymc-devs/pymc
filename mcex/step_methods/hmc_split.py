...
class HMCSplitStep(object):
    """Hamiltonian step method"""
    def __init__(self,model, vars, covariance, approx_loc, approx_cov, step_size_scaling = .25, trajectory_length = 2. , debug = False):
        self.mapping = DASpaceMap(vars)
        n = mapping.dimensions
