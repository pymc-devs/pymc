/* Generated by Pyrex 0.9.5.1a on Thu Oct  4 19:05:12 2007 */
...
static void __pyx_f_16Container_values_ACValue_under(PyObject *__pyx_v_container) {
  ...
  __pyx_1 = PyObject_GetAttr(__pyx_v_container, __pyx_n_val_ind); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; goto __pyx_L1;}
  __pyx_v_p_val_ind = ((long (*))PyArray_DATA(__pyx_1));
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "/Users/anand/renearch/PyMC/PyMC2/Container_values.pyx":85 */
  __pyx_1 = PyObject_GetAttr(__pyx_v_container, __pyx_n_nonval_ind); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; goto __pyx_L1;}
  ...
  __pyx_1 = PyObject_GetAttr(__pyx_v_container, __pyx_n__ravelleddata); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; goto __pyx_L1;}
  Py_DECREF(__pyx_v_ravelleddata);
  __pyx_v_ravelleddata = __pyx_1;
  __pyx_1 = 0;

  /* "/Users/anand/renearch/PyMC/PyMC2/Container_values.pyx":90 */
  __pyx_1 = PyObject_GetAttr(__pyx_v_container, __pyx_n_n_val); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; goto __pyx_L1;}
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_2; ++__pyx_v_i) {
    ...
    __pyx_1 = PyInt_FromLong(__pyx_v_ind); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_ravelleddata, __pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; goto __pyx_L1;}
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    __pyx_1 = PyObject_GetAttr(__pyx_3, __pyx_n_value); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/Users/anand/renearch/PyMC/PyMC2/Container_values.pyx":94 */
  __pyx_1 = PyObject_GetAttr(__pyx_v_container, __pyx_n_n_nonval); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; goto __pyx_L1;}
  __pyx_2 = PyInt_AsLong(__pyx_1); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_2; ++__pyx_v_i) {

    /* "/Users/anand/renearch/PyMC/PyMC2/Container_values.pyx":95 */
    __pyx_v_ind = (__pyx_v_p_nonval_ind[__pyx_v_i]);

    /* "/Users/anand/renearch/PyMC/PyMC2/Container_values.pyx":96 */
    __pyx_3 = PyInt_FromLong(__pyx_v_ind); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; goto __pyx_L1;}
    __pyx_1 = PyObject_GetItem(__pyx_v_ravelleddata, __pyx_3); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    __pyx_3 = PyInt_FromLong(__pyx_v_ind); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; goto __pyx_L1;}
    if (PyObject_SetItem(__pyx_v_ravelledvalue, __pyx_3, __pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_1); __pyx_1 = 0;
  }
