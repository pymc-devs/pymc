...
```@ARTICLE{2016arXiv160700379C, author = {{Coyle}, P.}, title = "{Probabilistic Programming and PyMC3}", journal = {ArXiv e-prints}, archivePrefix = "arXiv", eprint = {1607.00379}, primaryClass = "cs.OH", keywords = {Computer Science - Other Computer Science}, year = 2016, month = jul, adsurl = {http://adsabs.harvard.edu/abs/2016arXiv160700379C}, adsnote = {Provided by the SAO/NASA Astrophysics Data System} }
```
