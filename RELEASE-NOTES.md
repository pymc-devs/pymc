...
- Allow users to specify coordinates and dimension names instead of numerical shapes. This makes interoperability with ArviZ easier. ([see #3551](https://github.com/pymc-devs/pymc3/pull/3551))
