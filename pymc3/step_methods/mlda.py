    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.variance_reduction or self.store_Q_fine:
            ...
            if not isinstance(self.model.Q, aet.sharedvar.TensorSharedVariable):
                raise TypeError(
        ...
        if self.adaptive_error_model:
            ...
            if not (
                isinstance(self.model_below.mu_B, aet.sharedvar.TensorSharedVariable)
                and isinstance(self.model_below.Sigma_B, aet.sharedvar.TensorSharedVariable)
            ):
                raise TypeError(
