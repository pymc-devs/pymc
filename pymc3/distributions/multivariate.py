...
class _QuadFormBase(Continuous):
    def __init__(self, mu=None, cov=None, chol=None, tau=None, lower=True, *args, **kwargs):
        ...
        self.solve_lower = aet.slinalg.Solve(A_structure="lower_triangular")
...
class MatrixNormal(Continuous):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.solve_lower = aet.slinalg.solve_lower_triangular
        self.solve_upper = aet.slinalg.solve_upper_triangular
