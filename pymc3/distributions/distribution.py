...
def is_fast_drawable(var):
    return isinstance(var, (numbers.Number, np.ndarray, Constant, aet.sharedvar.SharedVariable))
    ...
    with _DrawValuesContext() as context:
        ...
        while stack:
            ...
            if (next_, size) in drawn:
                ...
                continue
            elif isinstance(next_, (Constant, aet.sharedvar.SharedVariable)):
...
def _draw_value(param, point=None, givens=None, size=None):
    ...
    if isinstance(param, (numbers.Number, np.ndarray)):
        ...
        return param.value
    elif isinstance(param, aet.sharedvar.SharedVariable):
