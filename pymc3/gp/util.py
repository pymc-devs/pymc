...
cholesky = aet.slinalg.cholesky
solve_lower = aet.slinalg.Solve(A_structure="lower_triangular")
solve_upper = aet.slinalg.Solve(A_structure="upper_triangular")
solve = aet.slinalg.Solve(A_structure="general")
