...
proposed by [Geweke_1992]_, is a time-series approach that compares the mean 
...
The second diagnostic provided by PyMC is the [Raftery_1995a]_ procedure. This 
...
(arbitrarily small) of the limiting distribution. See [Raftery_1995a]_ or 
[Gamerman_1997]_ for computational details. Estimates for sample size tend to 
be conservative.
...
package ([R_2010]_), via the `CODA`_ module ([Plummer_2008]_). PyMC includes a 
...
For example, the Bayesian p-value [Gelman_1996]_ uses a discrepancy measure 
...
Freeman-Tukey statistic [Brooks_2000]_:
