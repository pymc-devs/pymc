...
\pdfbookmark[0]{The Model class}{model}
...
\pdfbookmark[0]{The Sampler class}{sampler}
...
Samplers' attribute \texttt{deviance} is a deterministic variable valued as the model's deviance at its current state.
