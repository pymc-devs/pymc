...
\subsection{How fast is PyMC?}\label{speed} % (fold)
...
\chapter{Bayesian probability models} %(fold)
\begin{description}
...
% chapter chap:MCMC (end)

\chapter{Model building in PyMC} 

\section{\texttt{Parameter}s and \texttt{Node}s (needs to be updated...)}\label{sec:PyMCObjects} % (fold)
...
\subsection{Do not subclass \texttt{Parameter} or \texttt{Node}}\label{notsubclass} % (fold)

You will break them.

%(end)

\section{The Model class}\label{sec:Model} % (fold)

%(end)

\section{The SamplingMethod class}\label{sec:SamplingMethod} % (fold)

\subsection{OneAtATimeMetropolis}\label{sub:oneatatimemetropolis} % (fold)

%(end)
\subsection{JointMetropolis}\label{sub:jointmetropolis} % (fold)

%(end)
\subsection{\emph{Do} subclass SamplingMethod}\label{sub:do_subclass} % (fold)
...
\section{Under the hood of \texttt{Parameter} and \texttt{Node}}\label{underhood} % (fold)
...
\begin{center}
\epsfig{file=frame_1.pdf,width=10cm}
\end{center}
...
\begin{center}
\epsfig{file=frame_2.pdf,width=10cm}
\end{center}
...
\begin{center}
\epsfig{file=frame_3a.pdf,width=10cm}
\end{center}
...
\begin{center}
\epsfig{file=frame_3b.pdf,width=10cm}
\end{center}
