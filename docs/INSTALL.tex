...
\code{pymc} is known to run on Mac OS X, Linux and Windows, but in theory should be 
able to work on just about any platform for which Python, the NumPy module and a Fortran 
are available. Before installing \code{pymc}, you will need to install some dependencies; some are mandatory, while others substantially enrich the \code{pymc} experience.
