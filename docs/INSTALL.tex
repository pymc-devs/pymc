...
to easily create both directed and non directed graphs.
...
Pre-built binaries are available for Windows XP and Mac OS X. For other
platforms, you will need to build the package yourself from source.
...
The \titlereference{sudo} command is required to install PyMC into the Python
