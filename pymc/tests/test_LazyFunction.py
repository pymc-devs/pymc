...
class test_LazyFunction(NumpyTestCase):
    def check(self):
        for i in range(1000):
            ...
            assert(L.ultimate_args.value[0] is A.value)
            ...
            if acc:
                # A's value should be at the head of C's cache
                assert(L.cached_args[cur_frame*2] is A.value)
            ...
            # If jump was rejected:        
                ...
                assert(L.cached_args[(1-cur_frame)*2] is A.value)
