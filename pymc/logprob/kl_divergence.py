...
import pytensor.tensor.random.basic
...
@_kl_div.register(pytensor.tensor.random.basic.NormalRV, pytensor.tensor.random.basic.NormalRV)
def _normal_normal_kl(
    q_dist: pytensor.tensor.random.basic.NormalRV,
    p_dist: pytensor.tensor.random.basic.NormalRV,
