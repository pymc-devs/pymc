...
class ProgressBarManager:
    ...
    @staticmethod
    def compute_draw_speed(elapsed, actions, action_name="draw", time_unit="s"):
        speed = actions / max(elapsed, 1e-6)
    ...
    def update(self, chain_idx, is_last, draw, tuning, stats):
        ...
        speed, unit = self.compute_draw_speed(elapsed, draw, action_name="draw", time_unit="s")
...
class SMCProgressBarManager(ProgressBarManager):
    ...
    def update(self, chain_idx, stage, beta, old_beta=None, is_last=False):
        ...
        elapsed = self._progress.tasks[chain_idx].elapsed
        speed, unit = self.compute_draw_speed(elapsed, stage, action_name="stage", time_unit="s")
    ...
    def _create_smc_progress_bar(self, step_columns, progressbar, progressbar_theme):
