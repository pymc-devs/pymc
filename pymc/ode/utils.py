#   Copyright 2024 - 2025 The PyMC Developers
#
...
def make_sens_ic(n_states, n_theta, floatX):
    ...
    correspond to ode parameters, then the last n_theta columns in
    ...
    # Slip in the identity matrix in the appropriate place
