...
from pymc.pytensorf import _cheap_eval_mode, get_symbolic_rv_shapes
...
class ModelGraph:
    ...
    def get_plates(
        ...
        rv_shapes = get_symbolic_rv_shapes(all_nodes, raise_if_rvs_in_graph=False)
        shapes_fn = function([], rv_shapes, mode=_cheap_eval_mode)
