...
for klass in [Deterministic, Stochastic]:
    ...
    def __call__(self, *args, **kwargs):
        ...
        return Deterministic(eval_fun,
                                ...
                                trace=False,
                                plot=False)
    klass.__call__ = UnboundMethodType(__call__, None, klass)
