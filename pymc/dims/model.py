...
def Data(
    ...
    """Wrapper around regular Data that returns an XtensorVariable."""
    model = modelcontext(model)
    dims = convert_dims(dims)

    with model:
        value = RegularData(name, value, dims=dims, **kwargs)
    ...
    return as_xtensor(value, dims=dims, name=name)
...
def Deterministic(
    ...
    """Wrapper around pytensor.xtensor.deterministic that returns an XtensorVariable."""
...
def Potential(
    ...
    """Wrapper around pytensor.xtensor.potential that returns an XtensorVariable."""
